...
import sty from "./PlasmicButton.module.css"; // plasmic-import: bpJXnYRgPLH/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: uwRFoKRiRo0/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: xVPqqdg0u_X/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bBtoJ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___0TcEu)}
                role={"img"}
              />
            ),
